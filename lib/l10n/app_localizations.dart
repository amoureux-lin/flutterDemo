...
abstract class AppLocalizations {
  ...
  /// No description provided for @theme_button.
  ///
  /// In en, this message translates to:
  /// **'Switch Theme'**
  String get theme_button;

  /// No description provided for @locale_label.
  ///
  /// In en, this message translates to:
  /// **'Current Language'**
  String get locale_label;

  /// No description provided for @locale_button.
  ///
  /// In en, this message translates to:
  /// **'Switch Language'**
  String get locale_button;
